    ...
    <div className="flex flex-col lg:flex-row bg-gradient-to-b lg:bg-gradient-to-r dark:bg-transparent dark:bg-soft-black">
      ...
      <div className="flex w-full lg:justify-center">
        <div className="py-[2.5rem] flex flex-col lg:justify-center gap-[1rem] mx-[0.625rem] lg:mx-[1.5625rem]">
          ...
          <Link
            href="/contact"
            className="p-[1rem] text-center bg-transparent text-dark-blue dark:text-off-white text-sm md:text-base rounded-[.25rem] font-medium tracking-[.1rem] hover:bg-dark-blue dark:hover:bg-off-white hover:text-off-white dark:hover:text-dark-blue my-[1rem] border border-dark-blue dark:border-off-white md:w-fit"
          >
            Request A Quote
          </Link>
        </div>
